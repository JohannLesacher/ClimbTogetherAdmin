...
**Stack :** Next.js (App Router), Tailwind CSS, Shadcn/UI, Firebase (Client & Admin SDK), Zod, Tremor.

---

## 🛠 Principes de Développement & Règles
En tant qu'assistant sur ce projet, tu dois impérativement respecter ces règles :
